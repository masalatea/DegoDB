...
INSERT INTO project_source_outputs (
    ...
    @sample05_project_id,
    'DBACCESS-PHP',
    'Basic Select DBAccess (PHP)',
    'php',
    'DBAccess',
    'Release',
    '',
    'work/source-outputs/SAMPLE05/DBACCESS-PHP',
    'work/staging/source-outputs/SAMPLE05/DBACCESS-PHP',
    '',
    '',
    'UTF-8',
    'mtool/dbaccess-source-outputs/SAMPLE05/DBACCESS-PHP',
    'canonical-dbaccess-php',
    'runtime',
    'tar.gz',
    20,
    'Generate standalone PHP DBAccess classes from one class / one selectlist canonical metadata row set for the basic DBAccess tutorial sample.',
    'manual'
)
...
INSERT INTO project_source_outputs (
    ...
    @sample05_project_id,
    'DATACLASS-PHP',
    'Basic Select Data Class (PHP)',
    'php',
    'DataClass',
    'Release',
    '',
    'work/source-outputs/SAMPLE05/DATACLASS-PHP',
    'work/staging/source-outputs/SAMPLE05/DATACLASS-PHP',
    '',
    '',
    'UTF-8',
    'mtool/dataclass-source-outputs/SAMPLE05/DATACLASS-PHP',
    'canonical-dataclass-php',
    'runtime',
    'tar.gz',
    10,
    'Generate PHP data classes from canonical DataClass / DataClass fields metadata for the basic DBAccess tutorial sample.',
    'manual'
)
ON DUPLICATE KEY UPDATE
    name = VALUES(name),
...
INSERT INTO project_source_outputs (
    ...
    @sample05_project_id,
    'AI-CONTEXT-MD',
    'Sample5 AI Context Markdown',
    'md',
    'AIContext',
    'Release',
    '',
    'work/source-outputs/SAMPLE05/AI-CONTEXT-MD',
    'work/staging/source-outputs/SAMPLE05/AI-CONTEXT-MD',
    '',
    '',
    'UTF-8',
    'mtool/ai-context-source-outputs/SAMPLE05/AI-CONTEXT-MD',
    'ai-context-md',
    'runtime',
    'tar.gz',
    90,
