...
(@sample23_project_id, 'DATACLASS-PHP', 'Sample23 Data Class (PHP)', 'php', 'DataClass', 'Release', '', 'work/source-outputs/SAMPLE23/DATACLASS-PHP', 'work/staging/source-outputs/SAMPLE23/DATACLASS-PHP', '', '', 'UTF-8', 'mtool/dataclass-source-outputs/SAMPLE23/DATACLASS-PHP', 'canonical-dataclass-php', 'runtime', 'tar.gz', 10, 'disabled', 'Generate PHP data classes for the sample23 ebook media metadata demo.', 'manual'),
(@sample23_project_id, 'DBACCESS-PHP', 'Sample23 DBAccess (PHP)', 'php', 'DBAccess', 'Release', '', 'work/source-outputs/SAMPLE23/DBACCESS-PHP', 'work/staging/source-outputs/SAMPLE23/DBACCESS-PHP', '', '', 'UTF-8', 'mtool/dbaccess-source-outputs/SAMPLE23/DBACCESS-PHP', 'canonical-dbaccess-php', 'runtime', 'tar.gz', 20, 'disabled', 'Generate PHP DBAccess classes for the sample23 ebook media metadata demo.', 'manual'),
(@sample23_project_id, 'OPENAPI-JSON', 'Sample23 OpenAPI JSON', 'json', 'OpenAPI', 'Release', '', 'work/source-outputs/SAMPLE23/OPENAPI-JSON', 'work/staging/source-outputs/SAMPLE23/OPENAPI-JSON', 'http://127.0.0.1:8082/runs/proxy/SAMPLE23/API-PROXY-SERVER', '', '', 'mtool/openapi-source-outputs/SAMPLE23/OPENAPI-JSON', 'openapi-json', 'single-function-proxy', 'tar.gz', 30, 'internal-only', 'Generate OpenAPI JSON from ebook media asset metadata.', 'manual')
...
WHERE classes.project_id = @sample23_project_id
  AND classes.source_name = 'ebook_media_asset'
  AND functions.function_name IN (
      'GetPublicEbookMediaDeliveryList',
      'GetPublicEbookMediaAsset',
      'InsertEbookMediaAsset',
      'UpdateEbookMediaAssetMetadata'
  )
ON DUPLICATE KEY UPDATE
...
INSERT INTO project_source_outputs (
    ...
    @sample23_project_id,
    'AI-CONTEXT-MD',
    'Sample23 AI Context Markdown',
    'md',
    'AIContext',
    'Release',
    '',
    'work/source-outputs/SAMPLE23/AI-CONTEXT-MD',
    'work/staging/source-outputs/SAMPLE23/AI-CONTEXT-MD',
    '',
    '',
    'UTF-8',
    'mtool/ai-context-source-outputs/SAMPLE23/AI-CONTEXT-MD',
    'ai-context-md',
    'runtime',
    'tar.gz',
    90,
