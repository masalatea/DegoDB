...
- source output: `SAMPLE22/OPENAPI-JSON`
- display name: `Sample22 OpenAPI JSON`
- function count: `6`
- proxy base URL: `http://127.0.0.1:8082/runs/proxy/SAMPLE22/API-PROXY-SERVER`
...
- Lab/Admin viewer route: `/runs/swagger/SAMPLE22?source_output_key=OPENAPI-JSON`
