...
INSERT INTO project_source_outputs (
    ...
    @sample02_project_id,
    'DATACLASS-PHP',
    'Nullable Default Status Data Class (PHP)',
    'php',
    'DataClass',
    'Release',
    '',
    'work/source-outputs/SAMPLE02/DATACLASS-PHP',
    'work/staging/source-outputs/SAMPLE02/DATACLASS-PHP',
    '',
    '',
    'UTF-8',
    'mtool/dataclass-source-outputs/SAMPLE02/DATACLASS-PHP',
    'canonical-dataclass-php',
    'runtime',
    'tar.gz',
    10,
    'Generate PHP data classes from canonical DataClass / DataClass fields metadata for the nullable/default/status tutorial sample.',
    'manual'
)
...
INSERT INTO project_source_outputs (
    ...
    @sample02_project_id,
    'AI-CONTEXT-MD',
    'Sample2 AI Context Markdown',
    'md',
    'AIContext',
    'Release',
    '',
    'work/source-outputs/SAMPLE02/AI-CONTEXT-MD',
    'work/staging/source-outputs/SAMPLE02/AI-CONTEXT-MD',
    '',
    '',
    'UTF-8',
    'mtool/ai-context-source-outputs/SAMPLE02/AI-CONTEXT-MD',
    'ai-context-md',
    'runtime',
    'tar.gz',
    90,
