...
INSERT INTO project_html_definitions (
    ...
    200001,
    'SAMPLE20-PAGE',
    'Sample20 Content Publishing Page',
    200030,
    200100,
    10,
    '2026-06-19 00:00:00',
...
INSERT INTO project_html_parameters (
    ...
    (
        @sample20_project_id,
        @sample20_html_definition_id,
        200011,
        'PAGE_TITLE',
        'Sample20 Content Publishing',
        10,
        'Page title used by the sample20 tutorial module.',
        'manual'
    ),
    (
        @sample20_project_id,
        ...
        200012,
        'PAGE_BODY',
        'This sample publishes public article DataClass, DBAccess, HTML, and OpenAPI artifacts from one content model. Draft articles stay out of the public surface.',
        20,
        'Page body used by the sample20 tutorial module.',
        'manual'
    )
ON DUPLICATE KEY UPDATE
...
SET @sample20_html_definition_id = NULL;
