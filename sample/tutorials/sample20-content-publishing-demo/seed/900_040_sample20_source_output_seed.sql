...
(
    @sample20_project_id,
    'DATACLASS-PHP',
    'Sample20 Data Class (PHP)',
    'php',
    'DataClass',
    'Release',
    '',
    'work/source-outputs/SAMPLE20/DATACLASS-PHP',
    'work/staging/source-outputs/SAMPLE20/DATACLASS-PHP',
    '',
    '',
    'UTF-8',
    'mtool/dataclass-source-outputs/SAMPLE20/DATACLASS-PHP',
    'canonical-dataclass-php',
    'runtime',
    'tar.gz',
    10,
    'disabled',
    'Generate PHP data classes for the sample20 content publishing demo.',
    'manual'
),
(
    @sample20_project_id,
    'DBACCESS-PHP',
    'Sample20 DBAccess (PHP)',
    'php',
    'DBAccess',
    'Release',
    '',
    'work/source-outputs/SAMPLE20/DBACCESS-PHP',
    'work/staging/source-outputs/SAMPLE20/DBACCESS-PHP',
    '',
    '',
    'UTF-8',
    'mtool/dbaccess-source-outputs/SAMPLE20/DBACCESS-PHP',
    'canonical-dbaccess-php',
    'runtime',
    'tar.gz',
    20,
    'disabled',
    'Generate PHP DBAccess classes for the sample20 content publishing demo.',
    'manual'
),
(
    @sample20_project_id,
    'HTML-PAGE',
    'Sample20 HTML Page Module',
    'php',
    'html',
    'Release',
    'catalog://html-module/SAMPLE20/HTML-PAGE',
    'work/source-outputs/SAMPLE20/HTML-PAGE',
    'work/staging/source-outputs/SAMPLE20/HTML-PAGE',
    '',
    '',
    'UTF-8',
    'mtool/html-source-outputs/SAMPLE20/HTML-PAGE',
    'html-module-catalog',
    'runtime',
    'tar.gz',
    30,
    'disabled',
    'Publish a curated HTML module tree for the sample20 content publishing demo.',
    'manual'
),
(
    @sample20_project_id,
    'OPENAPI-JSON',
    'Sample20 OpenAPI JSON',
    'json',
    'OpenAPI',
    'Release',
    '',
    'work/source-outputs/SAMPLE20/OPENAPI-JSON',
    'work/staging/source-outputs/SAMPLE20/OPENAPI-JSON',
    'http://127.0.0.1:8082/runs/proxy/SAMPLE20/API-PROXY-SERVER',
    '',
    '',
    'mtool/openapi-source-outputs/SAMPLE20/OPENAPI-JSON',
    'openapi-json',
...
INSERT INTO project_html_source_bindings (
    ...
    'Tutorial binding for the sample20 HTML module source output.',
    'manual'
)
ON DUPLICATE KEY UPDATE
    source_output_key = VALUES(source_output_key),
...
INSERT INTO project_source_outputs (
    ...
    @sample20_project_id,
    'AI-CONTEXT-MD',
    'Sample20 AI Context Markdown',
    'md',
    'AIContext',
    'Release',
    '',
    'work/source-outputs/SAMPLE20/AI-CONTEXT-MD',
    'work/staging/source-outputs/SAMPLE20/AI-CONTEXT-MD',
    '',
    '',
    'UTF-8',
    'mtool/ai-context-source-outputs/SAMPLE20/AI-CONTEXT-MD',
    'ai-context-md',
    'runtime',
    'tar.gz',
    90,
