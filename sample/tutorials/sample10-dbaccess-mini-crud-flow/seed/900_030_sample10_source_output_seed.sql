...
INSERT INTO project_source_outputs (
    ...
    @sample10_project_id,
    'DBACCESS-PHP',
    'Mini CRUD Flow DBAccess (PHP)',
    'php',
    'DBAccess',
    'Release',
    '',
    'work/source-outputs/SAMPLE10/DBACCESS-PHP',
    'work/staging/source-outputs/SAMPLE10/DBACCESS-PHP',
    '',
    '',
    'UTF-8',
    'mtool/dbaccess-source-outputs/SAMPLE10/DBACCESS-PHP',
    'canonical-dbaccess-php',
    'runtime',
    'tar.gz',
    20,
    'Generate standalone PHP DBAccess classes from one class / two read function / three write function canonical metadata row set for the mini CRUD flow tutorial sample.',
    'manual'
)
...
INSERT INTO project_source_outputs (
    ...
    @sample10_project_id,
    'DATACLASS-PHP',
    'Mini CRUD Flow Data Class (PHP)',
    'php',
    'DataClass',
    'Release',
    '',
    'work/source-outputs/SAMPLE10/DATACLASS-PHP',
    'work/staging/source-outputs/SAMPLE10/DATACLASS-PHP',
    '',
    '',
    'UTF-8',
    'mtool/dataclass-source-outputs/SAMPLE10/DATACLASS-PHP',
    'canonical-dataclass-php',
    'runtime',
    'tar.gz',
    10,
    'Generate PHP data classes from canonical DataClass / DataClass fields metadata for the mini CRUD flow tutorial sample.',
    'manual'
)
ON DUPLICATE KEY UPDATE
    name = VALUES(name),
...
INSERT INTO project_source_outputs (
    ...
    @sample10_project_id,
    'AI-CONTEXT-MD',
    'Sample10 AI Context Markdown',
    'md',
    'AIContext',
    'Release',
    '',
    'work/source-outputs/SAMPLE10/AI-CONTEXT-MD',
    'work/staging/source-outputs/SAMPLE10/AI-CONTEXT-MD',
    '',
    '',
    'UTF-8',
    'mtool/ai-context-source-outputs/SAMPLE10/AI-CONTEXT-MD',
    'ai-context-md',
    'runtime',
    'tar.gz',
    90,
