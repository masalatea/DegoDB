...
WHERE legacy_html_template_pid = 180100
   OR legacy_template_parameter_pid IN (180101, 180102);
...
INSERT INTO html_templates (
    ...
    'html',
    0,
    'Sample18 Task Board Page Template',
    'php',
    'page.php',
    'Minimal HTML module template for sample18.',
    'Tutorial-owned canonical HTML template metadata. Runtime source is mtool/reference/html-modules/sample18/HTML-PAGE/current/page.php.',
    'manual'
)
...
INSERT INTO html_template_parameters (
    ...
    (
        ...
        0,
        'string',
        'Title value used by the sample18 task board module.',
        'manual'
    ),
    (
        180102,
        ...
        0,
        'string',
        'Body value used by the sample18 task board module.',
        'manual'
    )
ON DUPLICATE KEY UPDATE
