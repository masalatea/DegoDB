...
INSERT INTO project_html_parameters (
    ...
    (
        @sample18_project_id,
        @sample18_html_definition_id,
        180011,
        'PAGE_TITLE',
        'Sample18 Mini Task Board',
        10,
        'Page title used by the sample18 tutorial module.',
        'manual'
    ),
    (
        @sample18_project_id,
        ...
        180012,
        'PAGE_BODY',
        'Instruction-driven demo that publishes TaskCard DataClass, DBAccess, HTML, and OpenAPI artifacts from one small project.',
        20,
        'Page body used by the sample18 tutorial module.',
        'manual'
    )
ON DUPLICATE KEY UPDATE
...
SET @sample18_html_definition_id = NULL;
