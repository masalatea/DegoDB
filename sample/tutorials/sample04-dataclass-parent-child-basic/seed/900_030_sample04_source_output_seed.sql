...
INSERT INTO project_source_outputs (
    ...
    @sample04_project_id,
    'DATACLASS-PHP',
    'Parent Child Data Classes (PHP)',
    'php',
    'DataClass',
    'Release',
    '',
    'work/source-outputs/SAMPLE04/DATACLASS-PHP',
    'work/staging/source-outputs/SAMPLE04/DATACLASS-PHP',
    '',
    '',
    'UTF-8',
    'mtool/dataclass-source-outputs/SAMPLE04/DATACLASS-PHP',
    'canonical-dataclass-php',
    'runtime',
    'tar.gz',
    10,
    'Generate PHP data classes from canonical DataClass / DataClass fields metadata for the parent/child tutorial sample.',
    'manual'
)
...
INSERT INTO project_source_outputs (
    ...
    @sample04_project_id,
    'AI-CONTEXT-MD',
    'Sample4 AI Context Markdown',
    'md',
    'AIContext',
    'Release',
    '',
    'work/source-outputs/SAMPLE04/AI-CONTEXT-MD',
    'work/staging/source-outputs/SAMPLE04/AI-CONTEXT-MD',
    '',
    '',
    'UTF-8',
    'mtool/ai-context-source-outputs/SAMPLE04/AI-CONTEXT-MD',
    'ai-context-md',
    'runtime',
    'tar.gz',
    90,
