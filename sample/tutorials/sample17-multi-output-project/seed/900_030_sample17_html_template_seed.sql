...
WHERE legacy_html_template_pid = 170100
   OR legacy_template_parameter_pid IN (170101, 170102);
...
INSERT INTO html_templates (
    ...
    'html',
    0,
    'Sample17 Capstone Page Template',
    'php',
    'page.php',
    'Minimal HTML module template for sample17.',
    'Tutorial-owned canonical HTML template metadata. Runtime source is mtool/reference/html-modules/sample17/HTML-PAGE/current/page.php.',
    'manual'
)
...
INSERT INTO html_template_parameters (
    ...
    (
        ...
        0,
        'string',
        'Title value used by the sample17 capstone page module.',
        'manual'
    ),
    (
        170102,
        ...
        0,
        'string',
        'Body value used by the sample17 capstone page module.',
        'manual'
    )
ON DUPLICATE KEY UPDATE
