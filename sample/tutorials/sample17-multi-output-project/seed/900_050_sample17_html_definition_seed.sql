...
INSERT INTO project_html_parameters (
    ...
    (
        @sample17_project_id,
        @sample17_html_definition_id,
        170011,
        'PAGE_TITLE',
        'Sample17 Multi Output Project',
        10,
        'Page title used by the sample17 tutorial module.',
        'manual'
    ),
    (
        @sample17_project_id,
        ...
        170012,
        'PAGE_BODY',
        'This capstone project publishes DataClass, DBAccess, HTML, and OpenAPI artifacts from the same canonical metadata.',
        20,
        'Page body used by the sample17 tutorial module.',
        'manual'
    )
ON DUPLICATE KEY UPDATE
...
SET @sample17_html_definition_id = NULL;
