...
- source output: `SAMPLE17/OPENAPI-JSON`
- display name: `Sample17 OpenAPI JSON`
- function count: `2`
- proxy base URL: `http://127.0.0.1:8082/runs/proxy/SAMPLE17/API-PROXY-SERVER`
...
- Lab/Admin viewer route: `/runs/swagger/SAMPLE17?source_output_key=OPENAPI-JSON`
