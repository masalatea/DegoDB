...
- source output: `SAMPLE21/OPENAPI-JSON`
- display name: `Sample21 OpenAPI JSON`
- function count: `2`
- proxy base URL: `http://127.0.0.1:8082/runs/proxy/SAMPLE21/API-PROXY-SERVER`
...
- Lab/Admin viewer route: `/runs/swagger/SAMPLE21?source_output_key=OPENAPI-JSON`
