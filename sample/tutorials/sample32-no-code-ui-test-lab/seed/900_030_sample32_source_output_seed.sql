...
INSERT INTO project_source_outputs (
    ...
    @sample32_project_id,
    'NO-CODE-RUNTIME',
    'Sample32 No-Code Runtime JSON',
    'json',
    'NoCodeRuntime',
    'Release',
    '',
    'work/source-outputs/SAMPLE32/NO-CODE-RUNTIME',
    'work/staging/source-outputs/SAMPLE32/NO-CODE-RUNTIME',
    '',
    '',
    'UTF-8',
    'mtool/no-code-runtime-source-outputs/SAMPLE32/NO-CODE-RUNTIME',
    'no-code-runtime-json',
    'runtime',
    'tar.gz',
    70,
    'Generate no-code screen definition and runtime preview JSON for the dedicated no-code UI test lab.',
    'manual'
)
...
INSERT INTO project_source_outputs (
    ...
    @sample32_project_id,
    'AI-CONTEXT-MD',
    'Sample32 AI Context Markdown',
    'md',
    'AIContext',
    'Release',
    '',
    'work/source-outputs/SAMPLE32/AI-CONTEXT-MD',
    'work/staging/source-outputs/SAMPLE32/AI-CONTEXT-MD',
    '',
    '',
    'UTF-8',
    'mtool/ai-context-source-outputs/SAMPLE32/AI-CONTEXT-MD',
    'ai-context-md',
    'runtime',
    'tar.gz',
    90,
