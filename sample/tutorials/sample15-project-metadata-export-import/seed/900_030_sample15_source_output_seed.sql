...
INSERT INTO project_source_outputs (
    ...
    @sample15_project_id,
    'DATACLASS-PHP',
    'Bundle Metadata Data Class (PHP)',
    'php',
    'DataClass',
    'Release',
    '',
    'work/source-outputs/SAMPLE15/DATACLASS-PHP',
    'work/staging/source-outputs/SAMPLE15/DATACLASS-PHP',
    '',
    '',
    'UTF-8',
    'mtool/dataclass-source-outputs/SAMPLE15/DATACLASS-PHP',
    'canonical-dataclass-php',
    'runtime',
    'tar.gz',
    10,
    'Source output metadata included in the project metadata bundle tutorial sample.',
    'manual'
)
...
INSERT INTO project_source_outputs (
    ...
    @sample15_project_id,
    'AI-CONTEXT-MD',
    'Sample15 AI Context Markdown',
    'md',
    'AIContext',
    'Release',
    '',
    'work/source-outputs/SAMPLE15/AI-CONTEXT-MD',
    'work/staging/source-outputs/SAMPLE15/AI-CONTEXT-MD',
    '',
    '',
    'UTF-8',
    'mtool/ai-context-source-outputs/SAMPLE15/AI-CONTEXT-MD',
    'ai-context-md',
    'runtime',
    'tar.gz',
    90,
