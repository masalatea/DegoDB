...
INSERT INTO project_source_outputs (
    ...
    @sample19_project_id,
    'DBACCESS-PHP',
    'JSON-first Content Model DBAccess (PHP)',
    'php',
    'DBAccess',
    'Release',
    '',
    'work/source-outputs/SAMPLE19/DBACCESS-PHP',
    'work/staging/source-outputs/SAMPLE19/DBACCESS-PHP',
    '',
    '',
    'UTF-8',
    'mtool/dbaccess-source-outputs/SAMPLE19/DBACCESS-PHP',
    'canonical-dbaccess-php',
    'runtime',
    'tar.gz',
    20,
    'Generate standalone PHP DBAccess classes from AI-interpreted JSON-first content model metadata.',
    'manual'
)
...
INSERT INTO project_source_outputs (
    ...
    @sample19_project_id,
    'DATACLASS-PHP',
    'JSON-first Content Model Data Class (PHP)',
    'php',
    'DataClass',
    'Release',
    '',
    'work/source-outputs/SAMPLE19/DATACLASS-PHP',
    'work/staging/source-outputs/SAMPLE19/DATACLASS-PHP',
    '',
    '',
    'UTF-8',
    'mtool/dataclass-source-outputs/SAMPLE19/DATACLASS-PHP',
    'canonical-dataclass-php',
    'runtime',
    'tar.gz',
    10,
    'Generate PHP data classes from normalized tables interpreted from a user-provided JSON shape.',
    'manual'
)
ON DUPLICATE KEY UPDATE
    name = VALUES(name),
