...
- source output: `SAMPLE13/OPENAPI-JSON`
- display name: `Sample13 OpenAPI JSON`
- function count: `2`
- proxy base URL: `http://127.0.0.1:8082/runs/proxy/SAMPLE13/API-PROXY-SERVER`
...
- Lab/Admin viewer route: `/runs/swagger/SAMPLE13?source_output_key=OPENAPI-JSON`
