...
SET @sample08_db_access_class_id = LAST_INSERT_ID();
...
SET @sample08_get_summary_list_function_id = LAST_INSERT_ID();
...
SET @sample08_get_summary_list_function_id = NULL;
