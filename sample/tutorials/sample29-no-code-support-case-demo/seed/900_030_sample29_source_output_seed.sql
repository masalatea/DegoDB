...
INSERT INTO project_source_outputs (
    ...
    @sample29_project_id,
    'NO-CODE-RUNTIME',
    'Sample29 No-Code Runtime JSON',
    'json',
    'NoCodeRuntime',
    'Release',
    '',
    'work/source-outputs/SAMPLE29/NO-CODE-RUNTIME',
    'work/staging/source-outputs/SAMPLE29/NO-CODE-RUNTIME',
    '',
    '',
    'UTF-8',
    'mtool/no-code-runtime-source-outputs/SAMPLE29/NO-CODE-RUNTIME',
    'no-code-runtime-json',
    'runtime',
    'tar.gz',
    70,
    'Generate no-code screen definition and runtime preview JSON from sample29 shared contract and managed operation metadata.',
    'manual'
)
...
INSERT INTO project_source_outputs (
    ...
    @sample29_project_id,
    'AI-CONTEXT-MD',
    'Sample29 AI Context Markdown',
    'md',
    'AIContext',
    'Release',
    '',
    'work/source-outputs/SAMPLE29/AI-CONTEXT-MD',
    'work/staging/source-outputs/SAMPLE29/AI-CONTEXT-MD',
    '',
    '',
    'UTF-8',
    'mtool/ai-context-source-outputs/SAMPLE29/AI-CONTEXT-MD',
    'ai-context-md',
    'runtime',
    'tar.gz',
    90,
