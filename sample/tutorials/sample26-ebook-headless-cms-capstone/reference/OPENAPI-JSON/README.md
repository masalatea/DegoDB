...
- source output: `SAMPLE26/OPENAPI-JSON`
- display name: `Sample26 OpenAPI JSON`
- function count: `8`
- proxy base URL: `http://127.0.0.1:8082/runs/proxy/SAMPLE26/API-PROXY-SERVER`
...
- Lab/Admin viewer route: `/runs/swagger/SAMPLE26?source_output_key=OPENAPI-JSON`
