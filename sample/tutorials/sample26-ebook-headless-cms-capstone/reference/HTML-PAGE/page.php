...
$genreName = 'Guide';
$summary = 'JSONを入口に、電子書籍サイト、app向けAPI、編集者向け認証APIを1つのMtool projectから組み立てるcapstone sampleです。';
...
$chapters = [
    ...
    ['title' => '公開APIを考える', 'slug' => 'public-api', 'body' => '読者向けには公開済み章だけをspine順で返し、編集者向けの更新APIはProjectTokenで分けます。'],
];
...
<body>
    <header>
        <p class="meta">Headless CMS Capstone / <?php echo htmlspecialchars($genreName, ENT_QUOTES, 'UTF-8'); ?></p>
    ...
    <main class="reader-grid">
        ...
        <aside class="download-box">
            ...
            <p class="meta">Editor write API is published separately as a ProjectToken protected proxy.</p>
        </aside>
    </main>
</body>
</html>
