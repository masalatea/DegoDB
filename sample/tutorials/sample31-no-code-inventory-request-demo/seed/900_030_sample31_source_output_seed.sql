...
INSERT INTO project_source_outputs (
    ...
    @sample31_project_id,
    'NO-CODE-RUNTIME',
    'Sample31 No-Code Runtime JSON',
    'json',
    'NoCodeRuntime',
    'Release',
    '',
    'work/source-outputs/SAMPLE31/NO-CODE-RUNTIME',
    'work/staging/source-outputs/SAMPLE31/NO-CODE-RUNTIME',
    '',
    '',
    'UTF-8',
    'mtool/no-code-runtime-source-outputs/SAMPLE31/NO-CODE-RUNTIME',
    'no-code-runtime-json',
    'runtime',
    'tar.gz',
    70,
    'Generate no-code screen definition and runtime preview JSON from sample31 shared contract and managed operation metadata.',
    'manual'
)
...
INSERT INTO project_source_outputs (
    ...
    @sample31_project_id,
    'AI-CONTEXT-MD',
    'Sample31 AI Context Markdown',
    'md',
    'AIContext',
    'Release',
    '',
    'work/source-outputs/SAMPLE31/AI-CONTEXT-MD',
    'work/staging/source-outputs/SAMPLE31/AI-CONTEXT-MD',
    '',
    '',
    'UTF-8',
    'mtool/ai-context-source-outputs/SAMPLE31/AI-CONTEXT-MD',
    'ai-context-md',
    'runtime',
    'tar.gz',
    90,
