...
class EbookEditorChapterDBAccessBase
{
    ...
    // source_of_truth=manual class_source=manual action_type=UPDATE order=20 generation=canonical-bootstrap
    // reason=generated from canonical table metadata without legacy runtime source
    ...
    // source_of_truth=manual class_source=manual action_type=UPDATE order=30 generation=canonical-bootstrap
    // reason=generated from canonical table metadata without legacy runtime source
