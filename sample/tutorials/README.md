...
- [`sample01-simple-table-runtime`](sample01-simple-table-runtime/README.md)
- [`sample02-dataclass-nullable-default-status`](sample02-dataclass-nullable-default-status/README.md)
- [`sample03-dataclass-lookup-and-helper`](sample03-dataclass-lookup-and-helper/README.md)
- [`sample04-dataclass-parent-child-basic`](sample04-dataclass-parent-child-basic/README.md)
- [`sample05-dbaccess-select-basic`](sample05-dbaccess-select-basic/README.md)
- [`sample06-dbaccess-filter-sort-page`](sample06-dbaccess-filter-sort-page/README.md)
- [`sample07-dbaccess-crud-basic`](sample07-dbaccess-crud-basic/README.md)
- [`sample08-dbaccess-join-read-model`](sample08-dbaccess-join-read-model/README.md)
- [`sample09-dbaccess-aggregate-report`](sample09-dbaccess-aggregate-report/README.md)
- [`sample10-dbaccess-mini-crud-flow`](sample10-dbaccess-mini-crud-flow/README.md)
- [`sample11-html-template-output`](sample11-html-template-output/README.md)
- [`sample12-external-db-source-import`](sample12-external-db-source-import/README.md)
- [`sample13-openapi-api-surface`](sample13-openapi-api-surface/README.md)
- [`sample14-custom-proxy-runtime`](sample14-custom-proxy-runtime/README.md)
- [`sample15-project-metadata-export-import`](sample15-project-metadata-export-import/README.md)
- [`sample16-authenticated-proxy`](sample16-authenticated-proxy/README.md)
- [`sample17-multi-output-project`](sample17-multi-output-project/README.md)
- [`sample18-mini-task-board-demo`](sample18-mini-task-board-demo/README.md)
- [`sample19-json-first-content-model-demo`](sample19-json-first-content-model-demo/README.md)
- [`sample20-content-publishing-demo`](sample20-content-publishing-demo/README.md)
- [`sample21-ebook-catalog-api-demo`](sample21-ebook-catalog-api-demo/README.md)
- [`sample22-ebook-chapter-workflow-demo`](sample22-ebook-chapter-workflow-demo/README.md)
- [`sample23-ebook-media-metadata-demo`](sample23-ebook-media-metadata-demo/README.md)
- [`sample24-ebook-public-reader-site-demo`](sample24-ebook-public-reader-site-demo/README.md)
- [`sample25-ebook-editor-auth-cms-demo`](sample25-ebook-editor-auth-cms-demo/README.md)
- [`sample26-ebook-headless-cms-capstone`](sample26-ebook-headless-cms-capstone/README.md)
- [`sample27-app-local-persistence-demo`](sample27-app-local-persistence-demo/README.md)
- [`sample28-no-code-data-app-mvp`](sample28-no-code-data-app-mvp/README.md)
- [`sample29-no-code-support-case-demo`](sample29-no-code-support-case-demo/README.md)
- [`sample30-no-code-app-local-sync-demo`](sample30-no-code-app-local-sync-demo/README.md)
- [`sample31-no-code-inventory-request-demo`](sample31-no-code-inventory-request-demo/README.md)
- [`sample32-no-code-ui-test-lab`](sample32-no-code-ui-test-lab/README.md)
- [`sample33-sqlite-to-mysql-promotion`](sample33-sqlite-to-mysql-promotion/README.md)
- [`sample34-sqlite-to-firebird-promotion`](sample34-sqlite-to-firebird-promotion/README.md)
- [`sample35-capacitor-artifact-import`](sample35-capacitor-artifact-import/README.md)
- [`sample36-shared-state-sync-server-input`](sample36-shared-state-sync-server-input/README.md)
- [`sample37-shared-state-sync-client-input`](sample37-shared-state-sync-client-input/README.md)
- [`sample38-shared-state-sync-node-runtime`](sample38-shared-state-sync-node-runtime/README.md)
- [`sample39-shared-state-chat-demo`](sample39-shared-state-chat-demo/README.md)
- [`sample40-ephemeral-room-chat-site`](sample40-ephemeral-room-chat-site/README.md)
- [`sample41-simple-whiteboard`](sample41-simple-whiteboard/README.md)
- [`sample42-room-shooter-game`](sample42-room-shooter-game/README.md)
- [`sample43-tank-survival-game`](sample43-tank-survival-game/README.md)
- [`sample44-raycast-fps-line-demo`](sample44-raycast-fps-line-demo/README.md)
- [`sample45-map-info-popup-site`](sample45-map-info-popup-site/README.md)
- [`sample46-choice-adventure-game`](sample46-choice-adventure-game/README.md)
- [`sample47-open-world-rpg-demo`](sample47-open-world-rpg-demo/README.md)

`sample01`〜`sample32` は runtime pack であり、`compose.yaml` / `run.sh` / `seed/` を持つ。`sample33` は SQLite-to-MySQL promotion、`sample34` は SQLite-to-Firebird promotion の artifact-chain tutorial である。`sample34` は `reference/` fixture と PHPUnit contract に加え、opt-in Docker smoke で live Firebird import まで検証する。`sample35` は Capacitor-ready React app が Mtool artifact を直接 import できることを確認する app-wrapper tutorial であり、Mtool 想定操作を一通り網羅するが、`ios/` / `android/` / native build / signing は非scopeである。`sample36` は別 runtime の Node.js sync server owner が `sync-server-input.json` を読めることを、依存追加・server起動なしの静的fixtureで確認する。`sample37` は外部app client owner が `sync-client-input.json` を読めることを、SDK/source生成なしの静的fixtureで確認する。`sample38` は sample36/37 の packet と Mtool CLI 生成 packet を読む dependency-free Node.js reference runtime として、room membership、revision conflict、room-scoped event fanout、latest fetch、secret-free event を検証する。`sample39` は sample38 の上に乗るチャット風 domain sample として、message list append、revision conflict、room-scoped fanout、secret-free event を検証する。`sample40` は切り出しやすい URL room chat site sample として、image attachment metadata、ephemeral local image store、24h message expiry、7d inactive room expiry、room registry、same URL recreation、SQLite default store、production hardening checklist を検証する。`sample41` は static-first whiteboard sample として、pen / eraser / text / color / size / undo / clear / PNG export を検証する。`sample42` は room shooter game sample として、Mtool shared-state handoff packet 上の game contract、2-player join、move、shoot、hit/HP、room-scoped SSE update を検証する。`sample43` は tank survival game sample として、Mtool shared-state handoff packet 上の tank game contract、人数無制限 join、途中参加、全方向移動、障害物、前方弾、HP/explosion、last-alive winner、7日未活動reset を検証する。`sample44` は raycast FPS line demo として、Mtool shared-state handoff packet 上の FPS contract、line-only canvas raycasting、5-degree turn、wall collision、forward-angle shooting、HP/defeat、last-alive winner、7日未活動reset を検証する。`sample45` は map info popup site sample として、key-free local map-like panel、structured location data、marker/list click popup、category filter、popup field schema を検証する。`sample46` は choice adventure game sample として、opening、CSS flipbook scene、keyboard up/down/enter、mouse/touch choices、adventure API contract、mock API adapter、five-choice goal path、game over、back/restart、structured scenario packet を検証する。`sample47` は open world RPG demo として、Node.js通信、URL room、複数player join、PvPなし、敵spawn/tick/弱攻撃、剣攻撃、EXP/Gold、idle HP回復、障害物collision、room-scoped SSE を検証する。
