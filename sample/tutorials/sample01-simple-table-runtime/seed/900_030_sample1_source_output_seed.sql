...
INSERT INTO project_source_outputs (
    ...
    @sample1_project_id,
    'DBACCESS-PHP',
    'Simple Table DBAccess (PHP)',
    'php',
    'DBAccess',
    'Release',
    '',
    'work/source-outputs/SAMPLE1/DBACCESS-PHP',
    'work/staging/source-outputs/SAMPLE1/DBACCESS-PHP',
    '',
    '',
    'UTF-8',
    'mtool/dbaccess-source-outputs/SAMPLE1/DBACCESS-PHP',
    'canonical-dbaccess-php',
    'runtime',
    'tar.gz',
    20,
    'Generate standalone PHP DBAccess classes from canonical project_db_access_* metadata for the minimal single-table CRUD sample.',
    'manual'
)
...
INSERT INTO project_source_outputs (
    ...
    @sample1_project_id,
    'DATACLASS-PHP',
    'Simple Table Data Class (PHP)',
    'php',
    'DataClass',
    'Release',
    '',
    'work/source-outputs/SAMPLE1/DATACLASS-PHP',
    'work/staging/source-outputs/SAMPLE1/DATACLASS-PHP',
    '',
    '',
    'UTF-8',
    'mtool/dataclass-source-outputs/SAMPLE1/DATACLASS-PHP',
...
INSERT INTO project_source_outputs (
    ...
    @sample1_project_id,
    'AI-CONTEXT-MD',
    'Sample1 AI Context Markdown',
    'md',
    'AIContext',
    'Release',
    '',
    'work/source-outputs/SAMPLE1/AI-CONTEXT-MD',
    'work/staging/source-outputs/SAMPLE1/AI-CONTEXT-MD',
    '',
    '',
    'UTF-8',
    'mtool/ai-context-source-outputs/SAMPLE1/AI-CONTEXT-MD',
    'ai-context-md',
    'runtime',
    'tar.gz',
    90,
