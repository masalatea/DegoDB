...
- `runtime pack`
  ...
  - `seed/`
  - 必要なら `reference/`
- `promotion tutorial sample`
  - `README.md`
  - `reference/`
  - SQLite-to-MySQL promotion の artifact chain を検証する tutorial fixture
