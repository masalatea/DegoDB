...
SAMPLE28_PACK_DIR := sample/tutorials/sample28-no-code-data-app-mvp
SAMPLE28_COMPOSE_FILE := $(SAMPLE28_PACK_DIR)/compose.yaml
SAMPLE28_RUN := ./$(SAMPLE28_PACK_DIR)/run.sh
SAMPLE29_PACK_DIR := sample/tutorials/sample29-no-code-support-case-demo
SAMPLE29_COMPOSE_FILE := $(SAMPLE29_PACK_DIR)/compose.yaml
SAMPLE29_RUN := ./$(SAMPLE29_PACK_DIR)/run.sh
SAMPLE30_PACK_DIR := sample/tutorials/sample30-no-code-app-local-sync-demo
SAMPLE30_COMPOSE_FILE := $(SAMPLE30_PACK_DIR)/compose.yaml
SAMPLE30_RUN := ./$(SAMPLE30_PACK_DIR)/run.sh
SAMPLE31_PACK_DIR := sample/tutorials/sample31-no-code-inventory-request-demo
SAMPLE31_COMPOSE_FILE := $(SAMPLE31_PACK_DIR)/compose.yaml
SAMPLE31_RUN := ./$(SAMPLE31_PACK_DIR)/run.sh
SAMPLE32_PACK_DIR := sample/tutorials/sample32-no-code-ui-test-lab
SAMPLE32_COMPOSE_FILE := $(SAMPLE32_PACK_DIR)/compose.yaml
SAMPLE32_RUN := ./$(SAMPLE32_PACK_DIR)/run.sh
...
.PHONY: sample07-no-code-runtime-ui-smoke sample18-no-code-public-runtime-filter-dom-smoke sample18-no-code-public-runtime-disabled-action-smoke sample18-no-code-public-runtime-enabled-candidate-smoke sample18-no-code-preview-availability-diagnostics-smoke sample28-no-code-runtime-ui-smoke sample28-no-code-public-runtime-browser-smoke sample28-no-code-react-bridge-build-smoke sample28-no-code-react-bridge-browser-smoke sample28-no-code-schema-form-runtime-smoke sample29-no-code-runtime-ui-smoke sample29-no-code-public-runtime-browser-smoke sample31-no-code-runtime-ui-smoke sample31-no-code-public-runtime-browser-smoke sample-no-code-public-runtime-browser-smoke
...
DOCKER_ENV_TARGETS := \
	...
	sample28-runtime-output-test \
	sample29-runtime-output-test \
	sample30-runtime-output-test \
	sample31-runtime-output-test \
	sample32-runtime-output-test \
	sample9-output-test \
...
test: ## 現在の自動テスト一式を実行する
	bash mtool/scripts/run_sample_pack_phpunit_test.sh \
		...
		--extra-seed=$(SAMPLE28_PACK_DIR)/seed \
		--extra-seed=$(SAMPLE29_PACK_DIR)/seed \
		--extra-seed=$(SAMPLE30_PACK_DIR)/seed \
		--extra-seed=$(SAMPLE31_PACK_DIR)/seed \
		--extra-seed=$(SAMPLE32_PACK_DIR)/seed \
...
sample18-no-code-public-runtime-filter-dom-smoke: ## sample18 public NO-CODE-RUNTIME status filter DOM preflight を headless Chrome で検証する
	bash mtool/scripts/check_sample18_no_code_public_runtime_filter_dom_smoke.sh

sample18-no-code-public-runtime-disabled-action-smoke: ## sample18 public NO-CODE-RUNTIME disabled managed action surface を headless Chrome で検証する
	bash mtool/scripts/check_sample18_no_code_public_runtime_disabled_action_smoke.sh

sample18-no-code-public-runtime-enabled-candidate-smoke: ## sample18 public NO-CODE-RUNTIME enabled-candidate managed action surface を headless Chrome で検証する
	bash mtool/scripts/check_sample18_no_code_public_runtime_enabled_candidate_smoke.sh

sample18-no-code-preview-availability-diagnostics-smoke: sample18-pack-runtime-test ## availability診断がcontrolを変更せずGETのみ行うことを検証する
	node mtool/scripts/check_no_code_preview_availability_diagnostics_smoke.js
...
sample28-no-code-runtime-ui-smoke: sample28-pack-runtime-test ## sample28 NO-CODE-RUNTIME HTML preview を headless Chrome で検証する
	node mtool/scripts/check_no_code_runtime_preview_ui_smoke.js \
		--profile=sample28 \
		--html=work/source-outputs/SAMPLE28/NO-CODE-RUNTIME/runtime-preview.html

sample28-no-code-public-runtime-browser-smoke: ## sample28 public NO-CODE-RUNTIME artifact/current/alias preview を headless Chrome で検証する
	bash mtool/scripts/check_sample28_no_code_public_runtime_browser_smoke.sh

sample28-no-code-react-bridge-build-smoke: sample28-pack-runtime-test ## sample28 NO-CODE-REACT-BRIDGE の React/Vite build を検証する
	node mtool/scripts/check_no_code_react_bridge_build_smoke.js \
		--bridge=work/source-outputs/SAMPLE28/NO-CODE-REACT-BRIDGE

sample28-no-code-react-bridge-browser-smoke: sample28-pack-runtime-test ## sample28 NO-CODE-REACT-BRIDGE を headless Chrome で検証する
	node mtool/scripts/check_no_code_react_bridge_browser_smoke.js \
		--bridge=work/source-outputs/SAMPLE28/NO-CODE-REACT-BRIDGE

sample28-no-code-schema-form-runtime-smoke: sample28-pack-runtime-test ## sample28 NO-CODE-JSON-FORMS-PROBE を schema-form runtime smoke で検証する
	node mtool/scripts/check_no_code_schema_form_runtime_smoke.js \
		--probe=work/source-outputs/SAMPLE28/NO-CODE-JSON-FORMS-PROBE

sample29-no-code-runtime-ui-smoke: sample29-pack-runtime-test ## sample29 NO-CODE-RUNTIME HTML preview を headless Chrome で検証する
	node mtool/scripts/check_no_code_runtime_preview_ui_smoke.js \
		--profile=sample29 \
...
sample31-no-code-runtime-ui-smoke: sample31-pack-runtime-test ## sample31 NO-CODE-RUNTIME HTML preview を headless Chrome で検証する
	node mtool/scripts/check_no_code_runtime_preview_ui_smoke.js \
		--profile=sample31 \
		--html=work/source-outputs/SAMPLE31/NO-CODE-RUNTIME/runtime-preview.html

sample31-no-code-public-runtime-browser-smoke: ## sample31 public NO-CODE-RUNTIME current/alias submit handoff を headless Chrome で検証する
	bash mtool/scripts/check_sample31_no_code_public_runtime_browser_smoke.sh

sample-no-code-public-runtime-browser-smoke: sample28-no-code-public-runtime-browser-smoke sample29-no-code-public-runtime-browser-smoke sample31-no-code-public-runtime-browser-smoke ## sample28/29/31 public NO-CODE-RUNTIME browser smoke matrix を実行する
...
sample28-pack-runtime-test: sample28-runtime-output-test ## sample28 tutorial runtime の no-code data app MVP integration test を実行する

sample29-pack-runtime-test: sample29-runtime-output-test ## sample29 tutorial runtime の no-code support case integration test を実行する

sample30-pack-runtime-test: sample30-runtime-output-test ## sample30 tutorial runtime の no-code App-local sync integration test を実行する

sample31-pack-runtime-test: sample31-runtime-output-test ## sample31 tutorial runtime の no-code inventory request integration test を実行する

sample32-pack-runtime-test: sample32-runtime-output-test ## sample32 tutorial runtime の no-code UI test lab integration test を実行する
...
sample28-runtime-output-test:
	bash mtool/scripts/run_sample_pack_phpunit_test.sh \
		--compose-file=$(SAMPLE28_COMPOSE_FILE) \
		--run-script=$(SAMPLE28_RUN) \
		--apply-pack-seed \
		--phpunit-target=/var/www/tests/Integration/Sample28NoCodeDataAppMvpTest.php

sample29-runtime-output-test:
	bash mtool/scripts/run_sample_pack_phpunit_test.sh \
		--compose-file=$(SAMPLE29_COMPOSE_FILE) \
		--run-script=$(SAMPLE29_RUN) \
		--apply-pack-seed \
		--phpunit-target=/var/www/tests/Integration/Sample29NoCodeSupportCaseDemoTest.php

sample30-runtime-output-test:
	bash mtool/scripts/run_sample_pack_phpunit_test.sh \
		--compose-file=$(SAMPLE30_COMPOSE_FILE) \
		--run-script=$(SAMPLE30_RUN) \
		--apply-pack-seed \
		--phpunit-target=/var/www/tests/Integration/Sample30NoCodeAppLocalSyncDemoTest.php

sample31-runtime-output-test:
	bash mtool/scripts/run_sample_pack_phpunit_test.sh \
		--compose-file=$(SAMPLE31_COMPOSE_FILE) \
		--run-script=$(SAMPLE31_RUN) \
		--apply-pack-seed \
		--phpunit-target=/var/www/tests/Integration/Sample31NoCodeInventoryRequestDemoTest.php

sample32-runtime-output-test:
	bash mtool/scripts/run_sample_pack_phpunit_test.sh \
		--compose-file=$(SAMPLE32_COMPOSE_FILE) \
		--run-script=$(SAMPLE32_RUN) \
		--apply-pack-seed \
		--phpunit-target=/var/www/tests/Integration/Sample32NoCodeUiTestLabTest.php
