...
.PHONY: sample07-no-code-runtime-ui-smoke sample28-no-code-runtime-ui-smoke sample28-no-code-react-bridge-build-smoke sample28-no-code-react-bridge-browser-smoke sample28-no-code-schema-form-runtime-smoke sample29-no-code-runtime-ui-smoke
