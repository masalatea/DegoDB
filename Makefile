...
.PHONY: sample07-no-code-runtime-ui-smoke sample18-no-code-public-runtime-filter-dom-smoke sample28-no-code-runtime-ui-smoke sample28-no-code-public-runtime-browser-smoke sample28-no-code-react-bridge-build-smoke sample28-no-code-react-bridge-browser-smoke sample28-no-code-schema-form-runtime-smoke sample29-no-code-runtime-ui-smoke sample29-no-code-public-runtime-browser-smoke sample31-no-code-runtime-ui-smoke sample31-no-code-public-runtime-browser-smoke sample-no-code-public-runtime-browser-smoke
