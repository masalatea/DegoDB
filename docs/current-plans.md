...
| --- | --- | --- | --- |
| 1 | Managed data operation layer / managed data operation layer | Operation metadata, permission policy binding, and sync skeleton | `ACTIVE_NEXT` |
| 2 | No-code screen definition and runtime MVP / no-code screen definition・runtime MVP | Generated list/detail/form definitions and minimal no-code runtime | `TODO` |
| 3 | No-code app sample / no-code app sample | User-facing data-first no-code sample that proves the roadmap end to end | `TODO` |
...
| 15 | Managed data operation layer / managed data operation layer | 2-4 weeks / 2-4 週間 | Operation definitions, operation fields, permission policy binding, storage-role checks, and sync skeleton. |
