...
| Mobile app handoff / wrapper roadmap / mobile app handoff・wrapper roadmap | `C1_CHECKPOINTED` | Main Plan rows #893-#900 are complete for C1 wrapper-readiness. CLI/source-output route integration, Flutter input packets, React Native input packets, and real Capacitor/native project work are parked until a concrete adoption need appears. |
