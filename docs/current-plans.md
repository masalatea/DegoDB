...
| --- | --- | --- | --- |
| 1 | No-code screen definition and runtime MVP / no-code screen definition・runtime MVP | Minimal runtime MVP path is complete through generated HTML, persisted update flow, basic UI smoke, and browser/headless update dispatch smoke | `DONE` |
| 2 | No-code app sample / no-code app sample | User-facing data-first no-code sample that proves the roadmap end to end; candidate `sample28-no-code-data-app-mvp` | `ACTIVE_NEXT` |
...
| 17 | No-code app sample / no-code app sample | 1-3 weeks after runtime MVP / runtime MVP 後 1-3 週間 | Active next. User-facing sample proving data-first no-code behavior end to end. Candidate: `sample28-no-code-data-app-mvp`. |
...
| 9 | `sample28-no-code-data-app-mvp` / `sample28-no-code-data-app-mvp` | `ACTIVE_NEXT` | 3 days - 1.5 weeks / 3 日 - 1.5 週間 | User-facing sample proving the data-first no-code path end to end. |
