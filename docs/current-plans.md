...
| --- | --- | --- | --- |
| 1 | No-code screen definition and runtime MVP / no-code screen definition・runtime MVP | Generated list/detail/form definitions and minimal no-code runtime | `TODO` |
...
| 16 | No-code screen definition and runtime MVP / no-code screen definition・runtime MVP | 5-9 weeks / 5-9 週間 | Generated list/detail/form definitions first, then minimal runtime that renders definitions and executes allowed operations. |
