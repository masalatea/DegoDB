...
- AI-authored context as source of truth; `AI-CONTEXT-MD` is generated by DegoDB / Mtool code from canonical metadata / AI が書いた context を source of truth とすること。`AI-CONTEXT-MD` は canonical metadata から DegoDB / Mtool code が生成する。
- Modernization audit output until its generator exists / generator ができる前に modernization audit output と言うこと。
