...
| PostgreSQL | Opt-in user DB / generated-output contract lane. Not Mtool config store support. / user DB / generated-output 側の opt-in contract lane。Mtool config store 対応ではない。 |
