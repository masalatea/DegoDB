...
| Firebird | Complete for the agreed opt-in Mtool/profile and one-way migration-path scope; not broad Firebird production support. / 合意済み opt-in Mtool/profile と一方向 migration-path scope では完了。Firebird 全般の production support ではない。 |
