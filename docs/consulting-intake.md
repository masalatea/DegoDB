...
| Question / 確認項目 | English | 日本語 |
| --- | --- | --- |
| DB engine | MySQL / MariaDB, SQLite, PostgreSQL, or future candidate. | MySQL / MariaDB、SQLite、PostgreSQL、将来候補のどれか。 |
...
| Desired output | DataClass, DBAccess, OpenAPI, HTML, proxy runtime, metadata bundle. | DataClass、DBAccess、OpenAPI、HTML、proxy runtime、metadata bundle のどれが必要か。 |
