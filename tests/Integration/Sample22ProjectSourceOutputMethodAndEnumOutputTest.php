...
final class Sample22ProjectSourceOutputMethodAndEnumOutputTest extends TestCase
{
    public function testReferenceOutputsStayInSync(): void
    {
        $result = app_sample22_projectsourceoutput_run(
            'phpunit',
            app_sample22_projectsourceoutput_default_reference_root(),
        );
    ...
    private function failureMessageFromResult(array $result): string
    {
        ...
        return is_string($encoded) && $encoded !== ''
            ? $encoded
            : 'sample22 ProjectSourceOutput method-and-enum verification returned ok=false';
    }
}
