...
final class Sample18ProjectUserTopLevelDeclarationOutputTest extends TestCase
{
    public function testReferenceOutputsStayInSync(): void
    {
        $result = app_sample18_projectuser_run(
            'phpunit',
            app_sample18_projectuser_default_reference_root(),
        );
    ...
    private function failureMessageFromResult(array $result): string
    {
        ...
        return is_string($encoded) && $encoded !== ''
            ? $encoded
            : 'sample18 ProjectUser top-level declaration verification returned ok=false';
    }
}
