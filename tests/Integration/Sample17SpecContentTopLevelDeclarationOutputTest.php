...
final class Sample17SpecContentTopLevelDeclarationOutputTest extends TestCase
{
    public function testReferenceOutputsStayInSync(): void
    {
        $result = app_sample17_speccontent_run(
            'phpunit',
            app_sample17_speccontent_default_reference_root(),
        );
    ...
    private function failureMessageFromResult(array $result): string
    {
        ...
        return is_string($encoded) && $encoded !== ''
            ? $encoded
            : 'sample17 SpecContent top-level declaration verification returned ok=false';
    }
}
