...
final class Sample9TestPatternDefaultPropertyOutputTest extends TestCase
{
    public function testReferenceOutputsStayInSync(): void
    {
        $result = app_sample9_testpattern_default_property_run(
            'phpunit',
            app_sample9_testpattern_default_property_default_reference_root(),
        );
    ...
    private function failureMessageFromResult(array $result): string
    {
        ...
        return is_string($encoded) && $encoded !== ''
            ? $encoded
            : 'sample9 TestPattern default-property verification returned ok=false';
    }
}
