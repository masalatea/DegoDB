...
final class Sample13ReqMethodAndEnumOutputTest extends TestCase
{
    public function testReferenceOutputsStayInSync(): void
    {
        $result = app_sample13_req_run(
            'phpunit',
            app_sample13_req_default_reference_root(),
        );
    ...
    private function failureMessageFromResult(array $result): string
    {
        ...
        return is_string($encoded) && $encoded !== ''
            ? $encoded
            : 'sample13 Req method-and-enum verification returned ok=false';
    }
}
