...
final class Sample3DataclassLookupAndHelperOutputTest extends TestCase
{
    public function testReferenceOutputsStayInSync(): void
    {
        $result = app_sample3_dataclass_run(
            app_bootstrap(),
            'phpunit',
            app_sample3_dataclass_default_reference_root(),
        );
        ...
        self::assertCount(
            count(APP_SAMPLE3_DATACLASS_TABLE_NAMES),
        ...
        self::assertCount(
            count(APP_SAMPLE3_DATACLASS_REFERENCE_SOURCE_OUTPUT_KEYS),
    ...
    private function failureMessageFromResult(array $result): string
    {
        ...
        return is_string($encoded) && $encoded !== ''
            ? $encoded
            : 'sample3 dataclass verification returned ok=false';
    }
}
