...
final class Sample14BuildSourceFuncCacheCompanionDeclarationsOutputTest extends TestCase
{
    public function testReferenceOutputsStayInSync(): void
    {
        $result = app_sample14_buildsourcefunccache_run(
            'phpunit',
            app_sample14_buildsourcefunccache_default_reference_root(),
        );
    ...
    private function failureMessageFromResult(array $result): string
    {
        ...
        return is_string($encoded) && $encoded !== ''
            ? $encoded
            : 'sample14 BuildSourceFuncCache companion-declarations verification returned ok=false';
    }
}
