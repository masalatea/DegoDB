...
final class Sample16LiveCheckResultCompanionDeclarationsOutputTest extends TestCase
{
    public function testReferenceOutputsStayInSync(): void
    {
        $result = app_sample16_livecheckresult_run(
            'phpunit',
            app_sample16_livecheckresult_default_reference_root(),
        );
    ...
    private function failureMessageFromResult(array $result): string
    {
        ...
        return is_string($encoded) && $encoded !== ''
            ? $encoded
            : 'sample16 LiveCheckResult companion-declarations verification returned ok=false';
    }
}
