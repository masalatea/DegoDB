...
final class Sample19HtmlTemplateTopLevelDeclarationOutputTest extends TestCase
{
    public function testReferenceOutputsStayInSync(): void
    {
        $result = app_sample19_htmltemplate_run(
            'phpunit',
            app_sample19_htmltemplate_default_reference_root(),
        );
    ...
    private function failureMessageFromResult(array $result): string
    {
        ...
        return is_string($encoded) && $encoded !== ''
            ? $encoded
            : 'sample19 htmlTemplate top-level declaration verification returned ok=false';
    }
}
