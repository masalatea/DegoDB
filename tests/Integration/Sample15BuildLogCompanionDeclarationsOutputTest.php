...
final class Sample15BuildLogCompanionDeclarationsOutputTest extends TestCase
{
    public function testReferenceOutputsStayInSync(): void
    {
        $result = app_sample15_buildlog_run(
            'phpunit',
            app_sample15_buildlog_default_reference_root(),
        );
    ...
    private function failureMessageFromResult(array $result): string
    {
        ...
        return is_string($encoded) && $encoded !== ''
            ? $encoded
            : 'sample15 BuildLog companion-declarations verification returned ok=false';
    }
}
