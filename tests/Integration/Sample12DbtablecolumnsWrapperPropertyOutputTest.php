...
final class Sample12DbtablecolumnsWrapperPropertyOutputTest extends TestCase
{
    public function testReferenceOutputsStayInSync(): void
    {
        $result = app_sample12_dbtablecolumns_run(
            'phpunit',
            app_sample12_dbtablecolumns_default_reference_root(),
        );
    ...
    private function failureMessageFromResult(array $result): string
    {
        ...
        return is_string($encoded) && $encoded !== ''
            ? $encoded
            : 'sample12 dbtablecolumns wrapper-property verification returned ok=false';
    }
}
