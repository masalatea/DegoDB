...
final class NoCodeRuntimeTest extends TestCase
{
    ...
    public function testRendersRuntimePreviewHtmlFromGeneratedScreenModels(): void
    {
        ...
        self::assertStringContainsString('Refresh preview is available after server submit.', $html);
        ...
        self::assertStringContainsString('Next result check: process the sync outbox item, then use Refresh preview to reload this screen.', $html);
        self::assertStringContainsString('Demo processing completed this item; use Refresh preview to reload the result.', $html);
