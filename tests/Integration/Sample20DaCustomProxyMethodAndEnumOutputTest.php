...
final class Sample20DaCustomProxyMethodAndEnumOutputTest extends TestCase
{
    public function testReferenceOutputsStayInSync(): void
    {
        $result = app_sample20_dacustomproxy_run(
            'phpunit',
            app_sample20_dacustomproxy_default_reference_root(),
        );
    ...
    private function failureMessageFromResult(array $result): string
    {
        ...
        return is_string($encoded) && $encoded !== ''
            ? $encoded
            : 'sample20 daCustomProxy method-and-enum verification returned ok=false';
    }
}
