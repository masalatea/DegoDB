...
final class Sample10CompareOutputCompanionDeclarationsOutputTest extends TestCase
{
    public function testReferenceOutputsStayInSync(): void
    {
        $result = app_sample10_compare_output_run(
            'phpunit',
            app_sample10_compare_output_default_reference_root(),
        );
    ...
    private function failureMessageFromResult(array $result): string
    {
        ...
        return is_string($encoded) && $encoded !== ''
            ? $encoded
            : 'sample10 CompareOutput companion-declarations verification returned ok=false';
    }
}
