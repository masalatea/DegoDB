...
function app_sample_pack_project_key_map(): array
{
    return [
        ...
        'sample11-html-template-output' => 'SAMPLE11',
        'sample12-external-db-source-import' => 'SAMPLE12',
        'sample13-openapi-api-surface' => 'SAMPLE13',
        'sample14-custom-proxy-runtime' => 'SAMPLE14',
        ...
        'sample19-json-first-content-model-demo' => 'SAMPLE19',
        'sample20-content-publishing-demo' => 'SAMPLE20',
        'sample21-ebook-catalog-api-demo' => 'SAMPLE21',
        'sample22-ebook-chapter-workflow-demo' => 'SAMPLE22',
        'sample23-ebook-media-metadata-demo' => 'SAMPLE23',
