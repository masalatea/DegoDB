...
export ADMIN_AUTH_STUB_SCOPES="${ADMIN_AUTH_STUB_SCOPES:-task_card:write}"
export MTOOL_NO_CODE_SERVER_AVAILABILITY_OVERLAY="${MTOOL_NO_CODE_SERVER_AVAILABILITY_OVERLAY:-1}"
export MTOOL_NO_CODE_TRANSACTION_FULL_GATE="${MTOOL_NO_CODE_TRANSACTION_FULL_GATE:-transaction_full_v1}"
export MTOOL_SAMPLE18_GENERATED_UI_EXECUTION_ENABLED="${MTOOL_SAMPLE18_GENERATED_UI_EXECUTION_ENABLED:-1}"
export MTOOL_SAMPLE18_GENERATED_SUBMIT_MUTATION_ENABLED="${MTOOL_SAMPLE18_GENERATED_SUBMIT_MUTATION_ENABLED:-1}"
export MTOOL_SAMPLE18_GENERATED_SUBMIT_EXECUTOR_ENABLED="${MTOOL_SAMPLE18_GENERATED_SUBMIT_EXECUTOR_ENABLED:-1}"
