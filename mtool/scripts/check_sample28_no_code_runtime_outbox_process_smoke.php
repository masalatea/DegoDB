...
function smoke_profile(string $profile): array
{
    $profiles = [
        ...
        'sample31' => [
            ...
            'sqlite_select' => 'SELECT id, request_number, requester_name, warehouse_code, item_sku, needed_by, quantity_needed, status, fulfillment_note FROM inventory_request WHERE id = ?',
