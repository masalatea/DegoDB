...
<title><?php print getres("TITLE_DA_FUNC_SELECT_WHERE_VIEW"); ?> - <?php print getres("TITLE_TOP"); ?></title>
// End Template Content
...
if ($NoError) {
	...
	printPathOnTopForDBAccessClass("Select's Where", $ProjectPID, $DAPID, $DAFuncPID, "", "", "", "", "");
	...
	if (count($dafuncselectwherelist) > 0) {
		
		$forSort = false;
		include_once("da_func_select_where_table_include.php");
...
<p>none</p>
    ...
    <p align="right"><a href="da_func_select_where_change_order.php?ProjectPID=<?php print urlencode($ProjectPID); ?>&DAPID=<?php print urlencode($DAPID); ?>&DAFuncPID=<?php print urlencode($DAFuncPID); ?>&<?php print makeRandStr(8); ?>">Change Order</a></p>
    <?php } // if DBWritePermission ?>
    <br>
    <br>
    <br>
