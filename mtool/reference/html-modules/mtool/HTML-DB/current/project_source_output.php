...
<title><?php print getres("TITLE_PROJECT_OUTPUT_SOURCE_VIEW"); ?> - <?php print getres("TITLE_TOP"); ?></title>
// End Template Content
...
if ($NoError) {
	...
	printPathOnTopForDBTable("Project's Source Output Setting", $ProjectPID, "", "");
	...
	if (count($ProjectSourceOutputList) > 0) {
		$forSort = false;
		$forEdit = true;
		include("project_source_output_table_include.php");
	} else {
		?>
    <p>none</p>
		<?php
	...
	if ($IsMtoolProjectOwner) {
		?>
		<p align="right"><a href="project_source_output_edit.php?ProjectPID=<?php print urlencode($ProjectPID); ?>&<?php print makeRandStr(8); ?>">Add New Project Output Setting</a></p>
		<p align="right"><a href="project_source_output_change_order.php?ProjectPID=<?php print urlencode($ProjectPID); ?>&<?php print makeRandStr(8); ?>">Change Order of Project Output Setting</a></p>
		<?php
	}
	?>
	<br>
