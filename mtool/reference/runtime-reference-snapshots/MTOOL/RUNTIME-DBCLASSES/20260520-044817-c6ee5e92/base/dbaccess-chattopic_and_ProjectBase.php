...
require_once __DIR__ . '/../_support/legacy-dbaccess/dbaccess-chattopic_and_Project.php';
...
class chattopic_and_ProjectDBAccessBase extends chattopic_and_ProjectDBAccessLegacy
{
    ...
    public function GetchattopicList($param_ProjectUser_username_where)
    {
        ...
        $last_sql_command_for_mtooldb = 'select Project.name, chattopic.ProjectPID, chattopic.PID, chattopic.name, chattopic.IsOld from Project join ProjectUser on ProjectUser.ProjectPID = Project.PID join chattopic on ProjectUser.ProjectPID = chattopic.ProjectPID' . ' where ' . 'ProjectUser.username = ' . '\'' . $mtooldb->real_escape_string($param_ProjectUser_username_where) . '\'' . ' order by chattopic.IsOld,chattopic.name,chattopic.PID';
