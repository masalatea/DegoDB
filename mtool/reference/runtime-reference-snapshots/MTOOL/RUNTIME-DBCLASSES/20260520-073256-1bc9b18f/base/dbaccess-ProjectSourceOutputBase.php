...
require_once __DIR__ . '/../_support/legacy-dbaccess/dbaccess-ProjectSourceOutput.php';
...
class ProjectSourceOutputDBAccessBase extends ProjectSourceOutputDBAccessLegacy
{
    ...
    // source_of_truth=sync-bootstrap action_type=SELECTSINGLE order=63 generation=canonical-sql
    ...
    // source_of_truth=sync-bootstrap action_type=INSERT order=110 generation=canonical-sql
    ...
    // source_of_truth=sync-bootstrap action_type=UPDATE order=142 generation=canonical-sql
    ...
    // source_of_truth=sync-bootstrap action_type=DELETE order=158 generation=canonical-sql
