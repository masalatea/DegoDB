...
if (!mtool_runtime_bundle_load_custom_wrapper('data-ProjectSourceOutput.php')) {
    // Generated wrapper entry for runtime data class.
    // Override `mtool/extensions/MTOOL/RUNTIME-DBCLASSES/data-ProjectSourceOutput.php` and extend `ProjectSourceOutputDataBase` for project-specific customizations.
