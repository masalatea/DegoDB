...
if ($NoError) {
	...
	$BuildSourceCacheByDataClass = $DABuildSourceCache->GetBuildSourceCache($PID, $ProjectPID);
...
if ($NoError) {
	...
	printPathOnTopForDataClasses("Data Class: " . $BuildSourceCacheByDataClass->Filename, $ProjectPID, "", "");
    ...
    <br>
    <br>
    <p><a href="./dataclasses.php?ProjectPID=<?php print urlencode($ProjectPID); ?>&<?php print makeRandStr(8); ?>">Back to Data Class List</a> / <a href="./?<?php print makeRandStr(8); ?>">Back to Project List</a></p>
    <?php
}
?>
// End Template Content
