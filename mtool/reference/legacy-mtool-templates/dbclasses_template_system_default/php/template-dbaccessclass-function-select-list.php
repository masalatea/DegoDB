	public function __FUNCTION_NAME__(__PARAMS__)
	{
		...
		$last_sql_command_for___DB_OBJECT__ = "select __SELECT_BY_DISTINCT____SELECT_COLUMNS__ from __SELECT_FROM____WHERE____GROUP_BY____HAVING____ORDER_BY____SELECT_LIMIT__";
